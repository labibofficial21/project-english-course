...
die("Connection failed: " . mysqli_connect_error());
      ...
      echo "Jumlah Jawaban Benar : $benar";
      echo nl2br("\n");
      echo "Jumlah Jawaban Salah</td><td> : $salah";
      echo nl2br("\n");
      echo "Jumlah Jawaban Kosong</td><td>: $kosong";
      echo nl2br("\n");
      echo nl2br("\n");
      echo "<a href='soal_user.php'>Pelajaran Selanjutnya</a>";
        ?>