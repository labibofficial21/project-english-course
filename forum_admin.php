...
<div class="container">
<a class="btn btn-success" href="tambah_forum_admin.php" data-toggle="modal" data-target="#exampleModalCenter">Tambah Forum</a>
<br>
<br>
    ...
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='forum2.php'>Masuk</a> | 
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Forum</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="tambah_forum_admin.php" method="post" name="form1">
            ...
            <div class="form-group">
            <label for="kategori">Kategori (pilih satu) :</label>
            ...
            <div class="form-group">
                <label for="buat">Created By :</label>
                <input type="text" class="form-control" id="buat" name="post">
            </div>
            
            <center><input type="submit" name="Submit" value="Tambah" class="btn btn-primary"></center>
	    </form>
      </div>
    </div>
  </div>
