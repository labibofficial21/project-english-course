...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!--  KEUNTUNGAN KAMAR BAHASA INGGRIS  -->
    <section id="service-head" class=" bg-feature">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12 m-auto">
                    <div class="section-heading text-white">
                        <h4 class="section-title">Keuntungan Kamar Bahasa Inggris</h4>
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="service-box">
                        ...
                        <div class="service-inner">
                            ...
                            <p>Course berisikan segala materi yang akan kita pelajari dari tahap awal hingga akhir.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="service-box ">
                        ...
                        <div class="service-inner">
                            <h4>Perkembangan</h4>
                            <p>Pantau perkembangan belajar Anda langsung dari pengajarnya.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="service-box">
                        ...
                        <div class="service-inner">
                            <h4>Bebas Belajar</h4>
                            <p>Atur jadwal kelas Anda melalui aplikasi website ini dan dashboard Anda.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="mb-5">
                        <h3 class="mb-2">Apa Kata Mereka?</h3>
                                        ...
                                        <div class="testimonial-content style-2">
                                            <div class="author-info ">
                                                <div class="author-img">
                                                    <img src="images/author/3.jpg" alt="" class="img-fluid">
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="testimonial-content style-2">
                                            <div class="author-info ">
                                                <div class="author-img">
                                                    <img src="images/author/2.jpg" alt="" class="img-fluid">
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="testimonial-content style-2">
                                            <div class="author-info ">
                                                <div class="author-img">
                                                    <img src="images/author/1.jpg" alt="" class="img-fluid">
                                                </div>
                                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="team-member">
                        ...
                        <p class="text-muted">Lead Analist</p>
                    </div>
                </div>
