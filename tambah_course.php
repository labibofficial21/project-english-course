...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <ul class="nav nav-tabs justify-content-center">
      <li class="nav-item">
        <a class="nav-link active" href="course_admin.php">Beginner</a>
      </li>
 ...
 <div class = "container">
	...
	if(isset($_POST['Submit'])) {
		...
		$result = mysqli_query($db, "INSERT INTO forum(name,kategori,post) VALUES('$nama','$kategori','$post')");
		
		// Show message when user added
		echo "Forum berhasil ditambah! <a href='forum_admin.php'>Lihat Forum</a>";
	}
	?>
  </div>
  </body>
