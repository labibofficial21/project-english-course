...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <br>
	<center><h4><br>Part 1 <br></h4></center>
    <div class="container">
    <div class="row">
    
    <div class="embed-responsive embed-responsive-16by9">
        <iframe width="665" height="374" src="https://www.youtube.com/embed/AzES-nhQFzk?list=PL0A0C8CFFE9712B76" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
	
	<br>
	<center><h4><br>Part 2 <br></h4></center>
    <div class="container">
    <div class="row">
    
    <div class="embed-responsive embed-responsive-16by9">
        <iframe width="665" height="374" src="https://www.youtube.com/embed/uqgKvNxhCvQ?list=PL0A0C8CFFE9712B76" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
	
	<br>
	<center><h4><br>Part 3 <br></h4></center>
    <div class="container">
    <div class="row">
    
    <div class="embed-responsive embed-responsive-16by9">
        <iframe width="665" height="374" src="https://www.youtube.com/embed/bOD6iXEq0qc?list=PL0A0C8CFFE9712B76" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
	
    <center>
	<br>    
	<a href="soal_user.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Soal</a>
	</br>
    </center>
