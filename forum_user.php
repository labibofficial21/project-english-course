...
<div class="container">
<a class="btn btn-success" href="tambah_forum_user.php" data-toggle="modal" data-target="#exampleModalCenter">Tambah Forum</a>
<br>
<br>
    ...
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='forum1.php'>Masuk</a></td></tr>";        
    }
    ?>
        </table>
    </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="tambah_forum_user.php" method="post" name="form1">
